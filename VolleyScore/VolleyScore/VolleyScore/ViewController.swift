 ...
 */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let destination = segue.destination as? SecondViewController {
            ...
            destination.hittingEfficiencies = hittingEfficiencies
            destination.kill_dest = kill_dest
            destination.hittingE_dest = hittingE_dest
            destination.hittingA_dest = hittingA_dest
            
            destination.ace_dest = ace_dest
            destination.servingE_dest = servingE_dest
            destination.servingA_dest = servingA_dest
        }
    }
